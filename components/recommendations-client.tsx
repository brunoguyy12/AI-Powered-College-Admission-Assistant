...
export function RecommendationsClient({
  ...
  const handleGenerateRecommendations = async () => {
    ...
    try {
      ...
      toast.success(
        `${newRecommendations.length} recommendations generated successfully!`
      );
    } catch (error) {
      ...
      {recommendations.length === 0 ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Generate personalized university recommendations powered by AI
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Based on your academic profile, location preferences, and budget,
              we'll recommend universities that match your goals and
              achievements. Recommended universities will be added to our
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    setRecommendationCount(Number.parseInt(e.target.value) || 5)
                  }
                  className="w-32"
                  placeholder="5"
                />
          ...
          <div className="flex justify-between items-center flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                {recommendations.length} universities recommended for you
              </p>
            </div>
            <div className="flex gap-2">
