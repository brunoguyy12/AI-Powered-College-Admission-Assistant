...
export default async function StudentDashboard() {
  ...
  const profileComplete =
    dbUser.studentProfile?.gpa && dbUser.studentProfile?.satScore;
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage your college applications and get AI recommendations
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {dbUser.studentProfile?.gpa?.toFixed(2) || "N/A"}
              </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Get started with your college journey
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              {dbUser.applications.length === 0 ? (
                <p className="text-sm text-muted-foreground">
                  No applications yet. Start by updating your profile!
                </p>
              ) : (
